...
export type LauncherProps = {
  ...
  onTerminalBlocksChange?: (terminalBlocks: import('../../../../types').TerminalCommandBlock[]) => void;
  ...
  onAgentTerminalBlocksChange?: (terminalBlocks: import('../../../../types').TerminalCommandBlock[]) => void;
  ...
  sharedTerminalBlocks?: import('../../../../types').TerminalCommandBlock[];
  ...
  sharedAgentTerminalBlocks?: import('../../../../types').TerminalCommandBlock[];
  title?: string;
};
