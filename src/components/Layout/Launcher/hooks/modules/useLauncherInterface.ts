...
export function useLauncherInterface(params: {
  ...
  const chatPanelView = useMemo(() => ({
    ...
    activeTerminalSurface.blocks,
    activeTerminalSurface.collapseBlock,
    activeTerminalSurface.error,
    activeTerminalSurface.expandBlock,
    activeTerminalSurface.expandedBlockIds,
    activeTerminalSurface.selectedBlockId,
    activeTerminalSurface.setSelectedBlockId,
    composerMode,
    handlers.handlePendingApprovalAccept,
    handlers.handlePendingApprovalAutoApprove,
    handlers.handlePendingApprovalEdit,
    handlers.handlePendingApprovalReject,
    handlers.handlePendingApprovalSaveEdit,
    handlers.handlePendingTopicChangeContinueConversation,
    handlers.handlePendingTopicChangeStartNewConversation,
    handlers.openConversationFromBlock,
    props.title,
    resolvedPendingApproval,
    runtime.requestCommandApproval,
  ...
  const trayPanelView = useMemo(() => ({
    ...
    composer.shellSource,
    handlers.handleHistoryEntrySelect,
    handlers.handleNewConversation,
    handlers.handleToggleCommands,
    handlers.handleTrayConversationSelect,
    ...
    runtime.chat,
    showOpenInApp,
    store.conversationSearchQuery,
    store.historyTab,
    store.modelTab,
    store.selectedCommandIndex,
    store.selectedHistoryIndex,
    store.selectedModelIndex,
    tray,
    ui.visibleModels,
    ui.visibleTrayConversations
  ]);
  const terminalComposerView = useMemo(() => ({
    ...
    remoteSession: runtime.activeRemoteSession,
    ...
    activeTerminalSurface.completionState,
    effectiveWorkingDirectory,
    effectiveWorkingDirectoryLabel,
    gitContext.gitContext,
    gitContext.isBranchMenuOpen,
    gitContext.switchBranch,
    gitContext.toggleBranchMenu,
    handlers.handleNavigateToParentDirectory,
    handlers.handleSelectWorkingDirectory,
    handlers.handleTerminalQueryChange,
    handlers.handleTerminalRecommendationClick,
    handlers.openCommandsTray,
    launchAgentComposer,
    openAppWindow,
    runtime.chat.query,
    runtime.activeRemoteSession,
    runtimeContext?.nodeVersion,
    shortcuts.handleComposerKeyDown,
    showOpenInApp,
    workingDirectory.closePicker,
    workingDirectory.isPickerOpen,
    workingDirectory.listing,
    workingDirectory.searchQuery,
    workingDirectory.setSearchQuery,
    workingDirectory.togglePicker
  ]);
  ...
  }), [closeModelDrawer, openAppWindow, openModelDrawer, store.setComposerSurface, tray.closeTray]);
  const composerBarView = useMemo(() => ({
    ...
    gitContext.switchBranch,
    gitContext.toggleBranchMenu,
    handlers.executeTerminalCommand,
    handlers.handleComposerQueryChange,
    handlers.handleComposerRecommendationClick,
    handlers.handleNavigateToParentDirectory,
    handlers.handleSelectWorkingDirectory,
    handlers.handleToggleTerminalAutoDetect,
    modelSelection.selectedModelLabel,
    modelSelection.selectedModelSupportsAttachments,
    modelSetupRequired,
    openAppWindow,
    openModelDrawer,
    recommendedAction,
    ...
    store.setAllowSingleCharacterCommandPrediction,
  ...
  return {
    ...
    views: {
      ...
      trayPanel: trayPanelView,
      terminalComposer: terminalComposerView,
      modelSetupOverlay: modelSetupOverlayView,
      composerBar: composerBarView,
    },
  };
}
