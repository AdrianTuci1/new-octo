...
fn resolve_suffix_from_raw_value_secret() {
    let key = "sk-ant-api03-XXXXXXXX-XXXXXXXX-XXXXXXXX-XXXXXXXX-XXXXXX-XXXXXXXX";
...
fn resolve_suffix_prefers_anthropic_api_key_variant_over_raw_value() {
    let anthropic_key = "sk-ant-api03-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX-placeholder";
    let raw_key = "sk-ant-api03-YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY-placeholder";
    let secrets = HashMap::from([
        (
            "my-anthropic-key".to_string(),
