---
name: add-mcp-server
description: Use this skill when helping users add MCP servers to their Octomus configuration, especially when they mention `/create-mcp`, MCP config files, or need help choosing between local stdio and remote HTTP/SSE servers.
---
...
- Global configs (`~/.octomus/.mcp.json`) run from the home directory.
